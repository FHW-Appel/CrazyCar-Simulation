"""Focused runtime test for MapService spawn and Car initialization.

Initializes pygame display, creates MapService, gets spawn location,
and creates Car at that spawn. Verifies basic integration between
map service and car model without running full simulation.

Usage:
    python tools/run_spawn_test.py
"""
import sys
