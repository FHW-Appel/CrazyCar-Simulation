"""Run 5-second debug simulation with full logging.

Quick test script for debugging car physics, control loop, and sensor data.
Enables CRAZYCAR_DEBUG logging and runs simulation in Python regulator mode.

Usage:
    python tools/run_5s_debug.py
"""
import os
